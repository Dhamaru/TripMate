// Smoke test for Atlas Agent Loop (mocked LLM client)
import { runAgentLoop } from "./agent/agentLoop";
import { AgentInput } from "./agent/types";

async function smokeTest() {
  console.log("--- Atlas Agent Loop Smoke Test ---");
      ...
      completions: {
        create: async () => ({
          choices: [
            {
              message: {
                content: "Hello! I am Atlas, your travel friend. I see you are on the home page.",
                tool_calls: [],
              },
            },
          ],
