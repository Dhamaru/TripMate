...
// Was pointed at NVIDIA — that key was removed when the agent moved to
// Gemini (see agentLoop.ts), leaving this client with an empty apiKey and
// AI trip generation failing outright. Point it at Gemini's OpenAI-
// compatible endpoint like the rest of the agent stack.
