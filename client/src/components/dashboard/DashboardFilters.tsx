            ...
            <div className="flex gap-2">
                <div className="relative flex-1">
                    ...
                    <input
                        ...
                        className="w-full bg-muted border border-border rounded-xl pl-9 pr-4 py-2.5 text-sm text-foreground placeholder:text-muted-foreground outline-none focus:border-[#163F73] transition-colors"
                ...
                <div className="bg-muted rounded-xl p-4 space-y-4 border border-border">
                    <div>
                        ...
                        <div className="flex flex-wrap gap-2">
                            {STATUSES.map(s => (
                                <button key={s}
                                    className={`px-3 py-1.5 rounded-full text-xs border transition-colors capitalize ${filters.status === s ? 'bg-[#163F73] border-[#163F73] text-white' : 'bg-transparent border-border text-muted-foreground hover:text-foreground'}`}
                    ...
                    <div>
                        ...
                        <div className="flex flex-wrap gap-2">
                            {STYLES.map(s => (
                                <button key={s}
                                    className={`px-3 py-1.5 rounded-full text-xs border transition-colors ${filters.travelStyle === s ? 'bg-[#163F73] border-[#163F73] text-white' : 'bg-transparent border-border text-muted-foreground hover:text-foreground'}`}
