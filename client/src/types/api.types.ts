...
export interface AuthUser { id: string; email: string; firstName: string; lastName: string; avatar?: string; profileImageUrl?: string; isGuest?: boolean; googleConnected?: boolean; googleId?: string; }

// Trips
export type TravelStyle = 'Luxury' | 'Adventure' | 'Budget' | 'Relaxed' | 'Cultural' | 'Family' | 'adventure' | 'relaxed' | 'cultural' | 'culinary' | 'standard' | 'budget' | 'luxury' | 'family'
export type TravelMedium = 'Flight' | 'Train' | 'RoadTrip' | 'car' | 'bus' | 'flight' | 'train' | 'walk' | 'transit' | 'road'
