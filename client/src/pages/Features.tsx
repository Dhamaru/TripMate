  ...
  return (
    <div className="min-h-screen bg-muted text-foreground">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
        {/* Header */}
        <div className="mb-4">
          <h1 className="text-4xl font-bold text-foreground mb-2">Travel Tools</h1>
          <p className="text-lg text-muted-foreground">Everything you need for your perfect trip</p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 mb-4">
          {features.map((feature, index) => (
            ...
            >
              <Card
                className="bg-card border-border elev-1 hover-lift smooth-transition cursor-pointer overflow-hidden group radius-md"
          ...
          <CardContent>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              ...
              <Link href="/app/journal">
                <Button variant="outline" className="w-full bg-muted border-border text-foreground hover:bg-card smooth-transition interactive-tap radius-md">
        ...
        {selectedFeature && selectedFeatureData && (
          ...
          >
            <motion.div
              ...
              className="bg-card border border-border radius-md max-w-md w-full max-h-[80vh] overflow-hidden"
            ...
            >
              <div className={`h-48 bg-gradient-to-br ${selectedFeatureData.color} flex items-center justify-center relative`}>
                ...
                <Button
                  variant="ghost"
                  size="sm"
                  className="absolute top-4 right-4 text-white hover:bg-card/20 smooth-transition interactive-tap min-tap-target"
                  onClick={() => setSelectedFeature(null)}
                >
                  <X className="w-4 h-4" />
                </Button>
              ...
              <div className="p-6">
                <h3 className="text-2xl font-bold text-foreground mb-2">{selectedFeatureData.title}</h3>
                ...
                <div className="space-y-3">
                  ...
                  <Button
                    variant="outline"
                    className="w-full bg-muted border-border text-foreground hover:bg-card smooth-transition interactive-tap radius-md"
                    onClick={() => setSelectedFeature(null)}
                  >
                    Close
                  </Button>
