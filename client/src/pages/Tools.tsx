...
export default function Tools() {
  return (
    <div>
      <div className="mb-8">
        <h1 className="text-3xl font-bold text-foreground tracking-tight">Travel Tools</h1>
        <p className="text-muted-foreground mt-1">Utilities to help you during your journey</p>
      </div>

      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
        {TOOLS.map((tool) => (
          <Link key={tool.title} href={tool.href}>
            <div className="bg-card rounded-3xl border border p-6 hover:border-[#F59E0B]/30 hover:shadow-md transition-all cursor-pointer group flex flex-col h-full">
