        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
            ...
            <div className="flex items-center space-x-4">
              <Link href="/" className="text-gray-300 hover:text-white px-3 py-2 rounded-lg text-sm font-medium transition-colors" data-testid="link-home">
                Home
              </Link>
              ...
              <Link href="/maps" className="text-white bg-ios-blue/20 px-3 py-2 rounded-lg text-sm font-medium" data-testid="link-maps">
                Maps
              </Link>
