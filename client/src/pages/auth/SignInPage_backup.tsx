                ...
                <CardContent>
                  <form onSubmit={handleSubmit} className="space-y-4">
                    ...
                    <div className="flex items-center space-x-2">
                      <input id="remember" type="checkbox" checked={remember} onChange={(e) => setRemember(e.target.checked)} className="h-4 w-4 rounded border-ios-gray" />
                      <Label htmlFor="remember" className="text-white">Keep me signed in</Label>
                    </div>
                  ...
                  <motion.div className="mt-4" initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.7 }} viewport={{ once: true }}>
                    ...
                    <div className="mt-4">
                      <motion.button
                        ...
                        className="w-full bg-ios-card hover:bg-ios-card text-white border border-ios-gray rounded-md px-4 py-2 smooth-transition interactive-tap min-tap-target"
                        type="button"
