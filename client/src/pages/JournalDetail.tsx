            ...
            <div className=" flex items-center justify-center p-4">
                <Card className="bg-card border max-w-md w-full">
                    <CardContent className="p-8 text-center">
                        ...
                        <Button onClick={() => navigate("/app/journal")} className="bg-[var(--explorer-blue)] w-full">
                            Back to Journal
                        </Button>
                    </CardContent>
                </Card>
                ...
                {isEditing ? (
                    ...
                    >
                        ...
                        {entry.photos && entry.photos.length > 0 ? (
                            ...
                            <motion.div
                                variants={itemVariants}
                                className="h-48 md:h-64 rounded-3xl bg-gradient-to-br from-[var(--explorer-blue)] to-[var(--explorer-blue-deep)] flex items-center justify-center mb-8 shadow-xl"
                            >
